                  ...
                  <td style="padding:6px 0;border-bottom:1px solid ${BORDER_COLOR};">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td align="right"><span style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:${TEXT_PRIMARY};font-weight:700;">${data.invoiceNumber}</span></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid ${BORDER_COLOR};">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td align="right"><span style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:${TEXT_PRIMARY};">${data.invoiceDate}</span></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td style="padding:14px 0 6px 0;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td align="right"><span style="font-family:Georgia,'Times New Roman',Times,serif;font-size:22px;color:${TEXT_PRIMARY};font-weight:bold;">&#8377;${data.grandTotal}</span></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td style="padding:6px 0;border-bottom:1px solid ${BORDER_COLOR};">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td align="right"><span style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:${TEXT_PRIMARY};font-weight:600;">${data.quotationDate}</span></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid ${BORDER_COLOR};">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td align="right">
                          <span style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:${TEXT_PRIMARY};font-weight:600;">${validUntilDate}</span><br/>

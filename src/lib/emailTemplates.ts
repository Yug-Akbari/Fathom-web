  ...
  const content = `
    ...
    <tr>
      <td style="padding:10px 40px 30px 40px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid ${BORDER_COLOR};border-radius:8px;background-color:#fafaf8;overflow:hidden;">
          <!-- Card header -->
          <tr>
            <td style="padding:12px 20px;border-bottom:1px solid ${BORDER_COLOR};">
              <span style="font-family:Arial,Helvetica,sans-serif;font-size:10px;letter-spacing:1px;color:${TEXT_PRIMARY};text-transform:uppercase;font-weight:bold;">Customer Care &amp; Direct Support</span>
            </td>
          </tr>
          <!-- Body -->
          <tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td width="33%" style="vertical-align:top;">
                    <span style="font-family:Arial,Helvetica,sans-serif;font-size:9px;letter-spacing:1px;color:${TEXT_MUTED};text-transform:uppercase;display:block;margin-bottom:4px;">Website</span>
                    <a href="https://fathomstore.in" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:${TEXT_PRIMARY};text-decoration:none;font-weight:bold;">fathomstore.in</a>
                  </td>
                  <td width="33%" style="vertical-align:top;">
                    <span style="font-family:Arial,Helvetica,sans-serif;font-size:9px;letter-spacing:1px;color:${TEXT_MUTED};text-transform:uppercase;display:block;margin-bottom:4px;">Email Desk</span>
                    <a href="mailto:fathom.support@gmail.com" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:${TEXT_PRIMARY};text-decoration:none;font-weight:bold;">fathom.support<br/>@gmail.com</a>
                  </td>
                  <td width="33%" style="vertical-align:top;">
                    <span style="font-family:Arial,Helvetica,sans-serif;font-size:9px;letter-spacing:1px;color:${TEXT_MUTED};text-transform:uppercase;display:block;margin-bottom:4px;">Helpline</span>
                    <span style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:${TEXT_PRIMARY};font-weight:bold;">+91 82385 43000</span>
                  </td>
                </tr>
              </table>
            </td>
